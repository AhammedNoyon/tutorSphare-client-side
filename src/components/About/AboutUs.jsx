...
const AboutUs = () => {
  return (
    <>
      <section className=" py-16 lg:py-28 w-11/12 md:w-3/4 mx-auto lg:flex lg:items-center lg:justify-between">
        <div className="lg:w-1/2 space-y-6">
          <h2 className="text-xs font-bold text-gray-600 tracking-wide uppercase dark:text-white">
            About Us
          </h2>
          <h1 className="text-4xl font-extrabold leading-snug dark:text-white">
