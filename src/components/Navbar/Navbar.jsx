      ...
      <div className="navbar-start">
        ...
        <div className="flex gap-x-2 items-center">
          <div className="hidden md:block h-[50px] w-[50px] ">
            <img
              className="w-full dark:rounded-full dark:bg-white"
              src={logo}
              alt=""
            />
          </div>
        ...
        <div>
          {user ? (
            <div className="dropdown dropdown-end">
              ...
              >
                <li>
                  <p className="justify-between text-2xl font-semibold">
                    {user?.displayName}
                  </p>
                </li>
                <li>
                  <p className="justify-between text-left font-semibold">
                    {user?.email}
                  </p>
                </li>
                <Link>
                  <button
                    ...
                    className="btn mt-2 px-8 bg-primaryColor text-white"
                  >
                    Logout
                  </button>
                </Link>
            ...
            <Link to="/login">
              <button className="border px-4 shadow-lg bg-primaryColor text-white font-bold rounded-lg py-2">
                Login
              </button>
            </Link>
          )}
